...
class App:
    def __init__(self,root):
        self.root=root
        self.root.title('Bass MIDI GUI PC v22')
    ...
    def state_dict(self):
        self.commit_current_view()
        return {
            'app':'Bass MIDI GUI PC','version':22,
    ...
    def save_project(self):
        try:
            ...
            state['format']='bass-midi-gui-project'
    ...
    def load_project(self):
        ...
        try:
            ...
            if state.get('format') not in (None,'bassproj','bass-midi-gui-project'):

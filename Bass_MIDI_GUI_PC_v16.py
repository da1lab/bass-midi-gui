...
class App:
    def __init__(self,root):
        self.root=root
        self.root.title('Bass MIDI GUI PC v16')
        ...
        style.configure('Bar.TCombobox',font=('',11))
        style.configure('Bar.TEntry',font=('',11))
        self.build_top()
        self.render()
    ...
    def build_bar(self,parent,index,b,row,col):
        ...
        def make_chord_input(parent_row,label,var,oct_var):
            ...
            box=ttk.Combobox(parent_row,textvariable=var,values=CHORDS,width=8,height=18,takefocus=True,style='Bar.TCombobox')
        ...
        for i in range(count):
            ...
            ttk.Label(cell,text=pos_text,font=('',10)).pack(pady=(0,1))
            entry=ttk.Entry(cell,textvariable=sv,width=4,justify='center',takefocus=True,style='Bar.TEntry')
            entry.pack()
